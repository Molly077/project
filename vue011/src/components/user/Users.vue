      ...
      <el-table :data="userlist" border stripe>
        ...
        <el-table-column label="状态">
          <template v-slot="scope">
            <el-switch v-model="scope.row.mg_state" @change="userStatedChanged(scope.row)"></el-switch>
          </template>
        </el-table-column>
        <el-table-column label="操作">
          <template v-slot='scope' width="140">
            <!-- 编辑按钮 -->
...
export default {
  ...
  methods: {
    ...
    // 监听switch开关状态的改变
    async userStatedChanged(userinfo) {
